...
for iba in isos_by_age:
    ...
    legend.extend(["5921751752101964416", "5921751408511009024", "5921376578117781760"])
    plt.legend(legend)
    plt.gca().invert_xaxis()
    plt.gca().invert_yaxis()
    plt.savefig(utils_path.append(output_dir, "%d_%s.eps" % (file_index,str(age))),bbox_inches='tight',pad_inches=0.02)
