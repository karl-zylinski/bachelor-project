...
data_types = ["integer","text","integer","integer","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","real","integer","integer","integer","integer","real","real","real","real","integer","integer","real","real","real","real","integer","integer","real","integer","integer","integer","integer","real","real","real","real","integer","real","real","real","real","integer","real","real","real","real","real","integer","real","real","real","real","real","integer","real","real","real","text","real","real","real","real","real","real","real","real","real","real","real","real","real","real","integer","real","real","real","real","real","real"]
parallax_idx = columns.index("parallax")
...
source_parallax_idx = columns.index("parallax")
source_parallax_over_error_idx = columns.index("parallax_over_error")
source_pmra_idx = columns.index("pmra")
source_pmra_error_idx = columns.index("pmra_error")
source_pmdec_idx = columns.index("pmdec")
source_pmdec_error_idx = columns.index("pmdec_error")
source_radial_velocity_idx = columns.index("radial_velocity")
source_radial_velocity_error_idx = columns.index("radial_velocity_error")
...
def is_valid(raw_values):
    ...
    if (raw_values[source_parallax_idx] == ""):
        skipped_no_parallax = skipped_no_parallax + 1
        return False

    # pmra error cut
    pmra_over_error = math.fabs(utils_str.to_float(raw_values[source_pmra_idx]) / utils_str.to_float(raw_values[source_pmra_error_idx]))
    if pmra_over_error < cut_pmra_over_error:
        skipped_cut_pmra = skipped_cut_pmra + 1
        return False

    # pmdec error cut
    pmdec_over_error = math.fabs(utils_str.to_float(raw_values[source_pmdec_idx]) / utils_str.to_float(raw_values[source_pmdec_error_idx]))
    if pmdec_over_error < cut_pmdec_over_error:
        skipped_cut_pmdec = skipped_cut_pmdec + 1
        return False

    # radial_velocity error cut
    radial_velocity_over_error = math.fabs(utils_str.to_float(raw_values[source_radial_velocity_idx]) / utils_str.to_float(raw_values[source_radial_velocity_error_idx]))
    if radial_velocity_over_error < cut_radial_velocity_over_error:
        skipped_cut_radial_velocity = skipped_cut_radial_velocity + 1
        return False

    # parallax error cut
    parallax_over_error = utils_str.to_float(raw_values[source_parallax_over_error_idx])
